...
def create_date_picker():
	...
	day_label_2 = ttk.Label(frame, text="Ngày:")
	day_label_2.grid(row=0, column=0, padx=5, pady=5)
	day_combobox_2 = ttk.Combobox(frame, values=days, width=5)
	day_combobox_2.grid(row=0, column=1, padx=5, pady=5)
	day_combobox_2.set(days[0])

	
	month_label_2 = ttk.Label(frame, text="Tháng:")
	month_label_2.grid(row=0, column=2, padx=5, pady=5)
	month_combobox_2 = ttk.Combobox(frame, values=months, width=5)
	month_combobox_2.grid(row=0, column=3, padx=5, pady=5)
	month_combobox_2.set(months[0])


	year_label_2 = ttk.Label(frame, text="Năm:")
	year_label_2.grid(row=0, column=4, padx=0, pady=5)
	year_combobox_2 = ttk.Combobox(frame, values=years, width=10)
	year_combobox_2.grid(row=0, column=5, padx=0, pady=5)
	year_combobox_2.set(years[0])

	submit_button = ttk.Button(frame, text="Xử lí", command=get_date)
